...
public class ChatBot extends JFrame implements ActionListener {
  ...
  public void actionPerformed(ActionEvent e) {
	...
	//Simple Statement to check if user has asked key phrase to intiate TwitterAPI
	// If true, the TwitterAPI class is called and the latest tweet about Ryan Reynolds is returned.
	   if(userInput.equals("what are people saying about you on twitter")){
        String tweet = TwitterAPI.tweetsAbout();

        chatArea.append("Ryan Reynolds: " + tweet);
      }
